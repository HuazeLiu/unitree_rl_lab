...
"""Push-on-table validation: kinematic sphere pushes the cable sideways."""
...
parser = argparse.ArgumentParser(description="Thick cable push-on-table validation scene.")
...
from cable.cable_scenes import run_push_scene

if __name__ == "__main__":
    run_push_scene(args_cli, simulation_app)
